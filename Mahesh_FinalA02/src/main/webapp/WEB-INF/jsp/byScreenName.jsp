...
<title>Movies By Screen Names</title>
  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link active" href="/viewmoviebyscreename">By Screen Name</a>
...
<br><br>
	<form action="/viewmoviebyscreename" method="get">
    <div class="button-container">
    	<c:forEach var="scName" items="${screenNames}" varStatus="loopStatus">
   			<button class="movie-button  ${param.screenName == scName || (param.screenName == null && loopStatus.index==0) ? 'active' : ''}" name="screenName" value="${scName}">${scName}</button>
	</c:forEach>
</div>
</form>
<br>
