  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
     <div class="navbar-nav">
        ...
        <a class="nav-link active" href="/viewmoviebycategory">By Category</a>
...
<br><br>
	<form action="/viewmoviebycategory" method="get">
    <div class="button-container">
    <button class="movie-button ${category == null || category == 'Action' ? 'active' : ''}" name="category" value="Action">Action</button>
    <button class="movie-button ${category == 'Drama' ? 'active' : ''}" name="category" value="Drama">Drama</button>
    <button class="movie-button ${category == 'Comedy' ? 'active' : ''}" name="category" value="Comedy">Comedy</button>
    <button class="movie-button ${category == 'Crime' ? 'active' : ''}" name="category" value="Crime">Crime</button>
</div>
</form>
<div>
	<p>Selected Category: ${category == null ? 'Action' : category}</p>
</div>
<table class="movie-table ${empty movies ? 'center-table' : ''}">
<c:choose>
